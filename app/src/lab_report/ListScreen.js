    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: "white", paddingTop: getStatusBarHeight() + 10, paddingHorizontal: 20 }} >
                ...
                <TouchableOpacity onPress={() => this.props.navigation.navigate("Home_lab_report")} style={{ width: 70, height: 70, borderWidth: 1, borderColor: "#23527C", borderRadius: 40, justifyContent: "center", alignItems: "center", alignSelf: "flex-end", top:20 }} >
